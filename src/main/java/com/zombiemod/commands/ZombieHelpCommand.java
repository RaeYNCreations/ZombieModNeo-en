...
public class ZombieHelpCommand {
    ...
    private static int showHelp(CommandContext<CommandSourceStack> context) {
        ...
        source.sendSuccess(() -> Component.literal("§a/zombiestop §7- Stop the current game"), false);
        ...
        source.sendSuccess(() -> Component.literal("§a/zombiemap create <nom> §7- Create new map"), false);
        source.sendSuccess(() -> Component.literal("§a/zombiemap delete <nom> §7- Delete a map"), false);
        ...
        source.sendSuccess(() -> Component.literal("  §7At your current position"), false);
        source.sendSuccess(() -> Component.literal("§a/zombiespawn add <mapname> [doorNumber] §7- Add zombie spawn"), false);
        ...
        source.sendSuccess(() -> Component.literal("§a/zombiespawn clear <mapname> §7- Clear all zombie spawns"), false);
        source.sendSuccess(() -> Component.literal("§a/zombiespawn list <mapname> §7- List all zombie spawns"), false);
        source.sendSuccess(() -> Component.literal(""), false);

        // CONFIGURATION: PORTES
        source.sendSuccess(() -> Component.literal("§e§l► DOORS:"), false);
        source.sendSuccess(() -> Component.literal("§a/zombiedoor add <mapname> <number> <cost>"), false);
        ...
        source.sendSuccess(() -> Component.literal("§a/zombiedoor remove <mapname> <number> §7- Remove a door"), false);
        source.sendSuccess(() -> Component.literal("§a/zombiedoor list <mapname> §7- List all doors"), false);
        source.sendSuccess(() -> Component.literal("§a/zombiedoor open <mapname> <number> §7- Open door (destroy blocks)"), false);
        source.sendSuccess(() -> Component.literal("§a/zombiedoor close <mapname> <number> §7- Closed door (restoring blocks)"), false);
        ...
        source.sendSuccess(() -> Component.literal("§a/weaponcrate add <cost> <itemId> §7- Create a crate"), false);
        ...
        source.sendSuccess(() -> Component.literal("§a/weaponcrate addammo <itemId> <quantity> <cost>"), false);
        ...
        source.sendSuccess(() -> Component.literal("§a/weaponcrate remove §7- Remove a crate"), false);
        source.sendSuccess(() -> Component.literal("§a/weaponcrate scan §7- Scan all crates"), false);
        source.sendSuccess(() -> Component.literal("§a/weaponcrate reload §7- Reset all crates"), false);
        ...
        source.sendSuccess(() -> Component.literal("§a/zombiejukebox add <cost> §7- Create a zombie jukebox"), false);
        ...
        source.sendSuccess(() -> Component.literal("§a/zombiejukebox remove §7- Remove a zombie jukebox"), false);
        source.sendSuccess(() -> Component.literal("§a/zombiejukebox list §7- List all jukeboxes"), false);
        source.sendSuccess(() -> Component.literal(""), false);
